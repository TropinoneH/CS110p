...
#pragma omp parallel for
            ...
            p_next[2 * N + N - 4] =
                    0.01171875 *
                    (p[(2 - 2) * N + (N - 4 - 2)] + p[(2 - 2) * N + (N - 4 + 2)] + p[(2 - 1) * N + (N - 4 + 3)] + p[(2 + 1) * N + (N - 4 + 3)]) +
                    ...
                    0.015625 * (p[(2 - 1) * N + (N - 4 - 3)] + p[(2) * N + (N - 4 + 3)] + p[(2 + 1) * N + (N - 4 - 3)] + p[(2 + 3) * N + (N - 4 - 1)] +
                                p[(2 + 3) * N + (N - 4 + 1)]) +
                    0.078125 * (p[(2 - 1) * N + (N - 4 - 1)] + p[(2 - 1) * N + (N - 4 + 1)]) +
                    0.00390625 * (p[(2) * N + (N - 4 - 4)] + p[(2 + 4) * N + (N - 4)]) +
                    0.0625 * (p[(2) * N + (N - 4 - 2)] + p[(2 + 2) * N + (N - 4)]) + 0.13671875 * (p[(2) * N + (N - 4)]) +
                    0.05859375 * (p[(2) * N + (N - 4 + 2)]) +
            ...
            p_next[2 * N + N - 2] =
                    ...
                    0.0625 * (p[(2 - 1) * N + (N - 2 - 1)]) +
                    0.00390625 * (p[(2) * N + (N - 2 - 4)] + p[(2 + 3) * N + (N - 2 + 1)] + p[(2 + 4) * N + (N - 2)]) +
            ...
            p_next[3 * N + N - 3] =
                    0.01171875 *
                    (p[(3 - 3) * N + (N - 3 - 1)] + p[(3 - 3) * N + (N - 3 + 1)] + p[(3 - 2) * N + (N - 3 + 2)] + p[(3 + 2) * N + (N - 3 + 2)]) +
                    ...
                    0.03125 * (p[(3 - 1) * N + (N - 3 + 2)] + p[(3 + 1) * N + (N - 3 + 2)]) +
                    0.00390625 * (p[(3) * N + (N - 3 - 4)] + p[(3 + 4) * N + (N - 3)]) +
            ...
            p_next[(N - 4) * N + 2] =
                    ...
                    0.015625 * (p[(N - 4 - 3) * N + (2 - 1)] + p[(N - 4 - 3) * N + (2 + 1)] + p[(N - 4 - 1) * N + (2 + 3)] + p[(N - 4 + 1) * N + (2 + 3)] +
                                p[(N - 4 + 3) * N + (2)]) +
                    0.01171875 *
                    (p[(N - 4 - 2) * N + (2 - 2)] + p[(N - 4 + 2) * N + (2 - 2)] + p[(N - 4 + 3) * N + (2 - 1)] + p[(N - 4 + 3) * N + (2 + 1)]) +
                    0.0625 * (p[(N - 4 - 2) * N + (2)] + p[(N - 4) * N + (2 + 2)]) +
                    0.0234375 * (p[(N - 4 - 2) * N + (2 + 2)] + p[(N - 4 + 2) * N + (2 + 2)]) +
                    0.03125 * (p[(N - 4 - 1) * N + (2 - 2)] + p[(N - 4 + 1) * N + (2 - 2)]) +
                    0.078125 * (p[(N - 4 - 1) * N + (2 - 1)] + p[(N - 4 + 1) * N + (2 - 1)]) +
                    0.09375 * (p[(N - 4 - 1) * N + (2 + 1)] + p[(N - 4) * N + (2 - 2)] + p[(N - 4 + 1) * N + (2 + 1)]) +
                    0.13671875 * (p[(N - 4) * N + (2)]) +
                    0.05859375 * (p[(N - 4 + 2) * N + (2)]);
            p_next[(N - 4) * N + N - 4] = 0.00390625 * (p[(N - 4 - 4) * N + (N - 4)] + p[(N - 4) * N + (N - 4 - 4)]) +
                                          0.015625 *
                                          (p[(N - 4 - 3) * N + (N - 4 - 1)] + p[(N - 4 - 3) * N + (N - 4 + 1)] + p[(N - 4 - 1) * N + (N - 4 - 3)] +
                                           p[(N - 4) * N + (N - 4 + 3)] + p[(N - 4 + 1) * N + (N - 4 - 3)] + p[(N - 4 + 3) * N + (N - 4)]) +
                                          0.0234375 *
                                          (p[(N - 4 - 2) * N + (N - 4 - 2)] + p[(N - 4 - 2) * N + (N - 4 + 2)] + p[(N - 4 + 2) * N + (N - 4 - 2)] +
                                           p[(N - 4 + 2) * N + (N - 4 + 2)]) +
                                          0.0625 * (p[(N - 4 - 2) * N + (N - 4)] + p[(N - 4) * N + (N - 4 - 2)]) +
                                          0.09375 *
                                          (p[(N - 4 - 1) * N + (N - 4 - 1)] + p[(N - 4 - 1) * N + (N - 4 + 1)] + p[(N - 4 + 1) * N + (N - 4 - 1)] +
                                           p[(N - 4 + 1) * N + (N - 4 + 1)]) +
                                          0.01171875 *
                                          (p[(N - 4 - 1) * N + (N - 4 + 3)] + p[(N - 4 + 1) * N + (N - 4 + 3)] + p[(N - 4 + 3) * N + (N - 4 - 1)] +
                                           p[(N - 4 + 3) * N + (N - 4 + 1)]) +
                                          0.140625 * (p[(N - 4) * N + (N - 4)]) +
                                          0.05859375 * (p[(N - 4) * N + (N - 4 + 2)] + p[(N - 4 + 2) * N + (N - 4)]);
            p_next[(N - 4) * N + N - 2] =
                    ...
                    0.296875 * (p[(N - 4) * N + (N - 2 + 1)]) + 0.03515625 * (p[(N - 4 + 2) * N + (N - 2)]) +
                    0.01171875 * (p[(N - 4 + 3) * N + (N - 2 - 1)]);
            p_next[(N - 3) * N + 1] =
            ...
            p_next[(N - 3) * N + 3] =
                    ...
                    0.015625 * (p[(N - 3 - 3) * N + (3 - 1)] + p[(N - 3 - 3) * N + (3 + 1)] + p[(N - 3 - 1) * N + (3 + 3)] + p[(N - 3) * N + (3 - 3)] +
                                p[(N - 3 + 1) * N + (3 + 3)]) +
                    0.0234375 * (p[(N - 3 - 2) * N + (3 - 2)] + p[(N - 3 - 2) * N + (3 + 2)]) +
                    0.0625 * (p[(N - 3 - 2) * N + (3)] + p[(N - 3) * N + (3 + 2)]) +
                    0.01171875 *
                    (p[(N - 3 - 1) * N + (3 - 3)] + p[(N - 3 + 1) * N + (3 - 3)] + p[(N - 3 + 2) * N + (3 - 2)] + p[(N - 3 + 2) * N + (3 + 2)]) +
                    0.09375 * (p[(N - 3 - 1) * N + (3 - 1)] + p[(N - 3 - 1) * N + (3 + 1)] + p[(N - 3 + 2) * N + (3)]) +
                    0.05859375 * (p[(N - 3) * N + (3 - 2)]) +
            ...
            p_next[(N - 3) * N + N - 3] = 0.00390625 * (p[(N - 3 - 4) * N + (N - 3)] + p[(N - 3) * N + (N - 3 - 4)]) +
                                          0.015625 *
                                          (p[(N - 3 - 3) * N + (N - 3 - 1)] + p[(N - 3 - 3) * N + (N - 3 + 1)] + p[(N - 3 - 1) * N + (N - 3 - 3)] +
                                           p[(N - 3 + 1) * N + (N - 3 - 3)]) +
                                          ...
                                          0.03125 *
                                          (p[(N - 3 - 1) * N + (N - 3 + 2)] + p[(N - 3 + 1) * N + (N - 3 + 2)] + p[(N - 3 + 2) * N + (N - 3 - 1)] +
                                           p[(N - 3 + 2) * N + (N - 3 + 1)]) +
            ...
            p_next[(N - 2) * N + N - 4] =
                    ...
                    0.01171875 * (p[(N - 2 - 1) * N + (N - 4 + 3)]) + 0.0390625 * (p[(N - 2) * N + (N - 4 - 2)]) +
                    0.03515625 * (p[(N - 2) * N + (N - 4 + 2)]) +
